...
(cl:defmethod cl:initialize-instance :after ((m <HuboHandCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HuboHandCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hubo_ros_msgs-msg:<HuboHandCommand> is deprecated: use hubo_ros_msgs-msg:HuboHandCommand instead.")))
