...
(cl:defclass <HuboCommand> (roslisp-msg-protocol:ros-message)
  ((joints
    :reader joints
    :initarg :joints
    :type (cl:vector hubo_ros_msgs-msg:HuboJointCommand)
   :initform (cl:make-array 0 :element-type 'hubo_ros_msgs-msg:HuboJointCommand :initial-element (cl:make-instance 'hubo_ros_msgs-msg:HuboJointCommand)))
   (num_joints
    :reader num_joints
    :initarg :num_joints
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <HuboCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HuboCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hubo_ros_msgs-msg:<HuboCommand> is deprecated: use hubo_ros_msgs-msg:HuboCommand instead.")))
...
(cl:defmethod num_joints-val ((m <HuboCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hubo_ros_msgs-msg:num_joints-val is deprecated.  Use hubo_ros_msgs-msg:num_joints instead.")
  (num_joints m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HuboCommand>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'joints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hubo_ros_msgs-msg:HuboJointCommand))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HuboCommand>)))
  ...
  (cl:format cl:nil "HuboJointCommand[] joints~%int32 num_joints~%~%================================================================================~%MSG: hubo_ros_msgs/HuboJointCommand~%string name~%float64 position~%float64 velocity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HuboCommand)))
  "Returns full string definition for message of type 'HuboCommand"
  (cl:format cl:nil "HuboJointCommand[] joints~%int32 num_joints~%~%================================================================================~%MSG: hubo_ros_msgs/HuboJointCommand~%string name~%float64 position~%float64 velocity~%~%~%"))
